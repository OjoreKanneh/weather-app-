...
const windDegreeOutput=document.querySelector('.windDegree');
...
console.log("console initial:"+cityInput);

cities.forEach((city) => {
    city.addEventListener('click',(e) => {
        cityInput=e.target.innerHTML;

        console.log("console is:"+cityInput);
...
function fetchWeatherData(cityInput){
    fetch(`http://api.weatherapi.com/v1/current.json?key=1f8884def19d4e38961155530222105&q=${cityInput}&aqi=no`)
